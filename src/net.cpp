...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Cookiecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"cookiecointools.com", "cookiecoinww.zapto.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"cookiecointools.com", "testnet-seed.cookiecointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Cookiecoin is probably already running."), addrBind.ToString().c_str());
        else
